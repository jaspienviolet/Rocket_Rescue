...
void loop() 
{
  ...
  while (info < 3)
  {
    ...
    if (s1 != 0)
    {
      Serial.print('s'); // Component Grid 2 Sound for first row
      Serial.print(',');
      Serial.print(s1);
      Serial.print('\n');
      s1 = 0;
    ...
    if (s2 != 0)
    {
      Serial.print('s'); // Component Grid 2 Sound for second row
      Serial.print(",");
      Serial.print(s2);
      Serial.print('\n');
      s2 = 0;
    ...
    if (s3 != 0)
    {
      Serial.print('s'); // Component Grid 2 Sound for third row
      Serial.print(',');
      Serial.print(s3);
      Serial.print('\n');
      s3 = 0;
    ...
    Serial.print("c"); // Component Grid 2 Check
